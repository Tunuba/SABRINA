...
extern Nodo *D_8008AB78[];           /* los nodos de las piezas, 0xF0 */

/* Deja sin dibujo (visible y triangulos en cero) los nodos de la tabla desde el numero dado hasta el
 * ultimo. El contador es de 16 bits pero el lugar en la tabla sigue desde el numero tal cual llego. */
void func_80020764(s32 i) {
    s32 k = i;

    while (i != 0xF0) {
        D_8008AB78[k]->visible = 0;
        D_8008AB78[k]->triangulos = 0;
        k++;
        i = (i + 1) & 0xFFFF;
    }
}
